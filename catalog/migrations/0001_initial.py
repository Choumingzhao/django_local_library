# Generated by Django 4.2.11 on 2024-03-12 09:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='genre',
            constraint=models.UniqueConstraint(django.db.models.functions.text.Lower('name'), name='genra_name_case_insensitive_unique', violation_error_message='Genre with this name already exists (case insensitive match).'),
        ),
        migrations.AddField(
